...
def parse(data):
    try:
   	sm_input = data[0].split("	")
    	date = datetime.datetime.fromtimestamp(float(sm_input[0])).strftime("%Y-%m-%dT%H:%M:%S.%fZ")
   	...
   	payload_1 =  "{date:"+date+", P:"+sm_input[1]+", P1:"+sm_input[2]+", P2:"+sm_input[3]+", P3:"+sm_input[4]+"}"
   	payload_2 =  "{date:"+date+", I0:"+sm_input[5]+", I1:"+sm_input[6]+", I2:"+sm_input[7]+", I3:"+sm_input[8]+"}"
   	payload_3 =  "{date:"+date+", V1:"+sm_input[9]+",V2:"+sm_input[10]+", V3:"+sm_input[11]+"}"
   	payload_4 =  "{date:"+date+", CR_P:"+str(cR_old_P1 + cR_old_P2 + cR_old_P3)+"}"
